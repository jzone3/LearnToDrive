...
function init() {
	...
	//test
	var tutorialButton = new gm.widgets.Button({label: "Tutorials",
        parentElement: document.getElementById('tutorial-button'),
        callBack: function(){
//        	totalTime = date.getSeconds()-startTime();
//        	cmlthttp.open("GET","url"+totalTime, true);
//        	
//http.send();
        	window.location.assign("tutorial.html");
        }
	}); 
	var statsButton = new gm.widgets.Button({label: "Statistics",
        parentElement: document.getElementById('stats-button') });
...
var startTTS = function(args) {
	gm.voice.startTTS(function(){}, function(){}, "Jemma Issroff hopes this works");
};
}
